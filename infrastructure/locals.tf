        ...
        palo_rules = {
          for palo_key in distinct([
            ...
            palo_tags = [
              ...
              "serviceType=${local.consumer_sg_first_combo[region][sg_key].policy.security_group.serviceType}",
              "serviceName=${replace(local.consumer_sg_first_combo[region][sg_key].policy.security_group.serviceName, "com.amazonaws.vpce.", "")}",
              "region=${local.consumer_sg_first_combo[region][sg_key].policy.security_group.region}"
            ]
